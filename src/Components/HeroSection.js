            ...
            <section className="bg-white dark:bg-black " style={{ "fontFamily": "Inter Extra" }}>
                <div className="py-8 px-4 mx-auto max-w-screen text-center lg:py-16 lg:px-12" style={{"backgroundColor": "rgb(248, 248, 248)"}}>
                    ...
                    <div className="flex flex-col mb-4 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                        <a href="/login" className="bg-black text-white inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                            Learn more
